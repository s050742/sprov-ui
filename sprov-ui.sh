...
#   Github - sprov-ui: https://github.com/s050742/sprov-ui/tree/jason
#======================================================
...
install() {
    install_base
    bash <(curl -L -s https://github.com/s050742/sprov-ui/tree/jason/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
install_bbr() {
    bash <(curl -L -s https://github.com/s050742/sprov-ui/tree/jason/bbr.sh)
    if [[ $? == 0 ]]; then
        echo ""
...
update_shell() {
    wget -O /usr/bin/sprov-ui -N --no-check-certificate https://github.com/s050742/sprov-ui/tree/jason/sprov-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
